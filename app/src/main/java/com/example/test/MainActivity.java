...
public class MainActivity extends AppCompatActivity {
    ...
    int S10, S20, S50, S100, S200, S500, S2000; //for storing total value for number of each note


    int getActualTotal() {
        ActualTotal = S10 + S20 + S50 + S100 + S200 + S500 + S2000;
        return ActualTotal;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView Buttoncheck = (TextView) findViewById(R.id.checktotal);
